...
exports.getSubadminListUseCase = exports.createSubadminUseCase = exports.createAdminUseCase = void 0;
...
const getSubadminListUseCase = async (options) => {
    return await (0, admin_repo_1.getSubadminListRepo)(options);
};
exports.getSubadminListUseCase = getSubadminListUseCase;
